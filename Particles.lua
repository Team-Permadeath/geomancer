...
Particle2:setSizes(2, 1)
--Particle2:setColors(220, 105, 20, 255, 194, 30, 18, 0)
Particle2:setPosition(400, 300)
...
Particle3:setSizes(2, 1)
--Particle3:setColors(220, 105, 20, 255, 194, 30, 18, 0)
Particle3:setPosition(400, 300)
